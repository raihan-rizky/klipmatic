...
const STATUS_MESSAGE = {
  ...
  'send-failed': 'Login gagal. Coba lagi beberapa saat.',
  'callback-failed': 'Session login gagal dibuat. Coba masuk lagi.',
  sent: 'Akun siap digunakan.',
} as const
    ...
    <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-5xl items-center gap-10 py-4 lg:grid-cols-[1fr_440px]">
      <div className="max-w-xl">
        ...
        <h1 className="mt-6 text-4xl font-black tracking-normal sm:text-5xl">
          Daftar sekali, langsung bikin klip.
        </h1>
        <p className="mt-5 text-base leading-7 text-muted">
          Buat akun dengan email dan password, lalu langsung masuk tanpa verifikasi email.
        </p>
      ...
      <Card className="border-primary/15 bg-surface-raised/95">
        <CardHeader>
          <CardTitle className="text-2xl">Buat akun Klipmatic</CardTitle>
          <p className="text-sm leading-6 text-muted">
            Email dan password kamu langsung dipakai untuk masuk ke workspace.
          </p>
        </CardHeader>
        <CardContent>
          <PasswordAuthForm initialMessage={message} />
        </CardContent>
      </Card>
    </section>
  )
